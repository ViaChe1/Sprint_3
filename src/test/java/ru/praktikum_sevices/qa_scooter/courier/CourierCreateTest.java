...
public class CourierCreateTest {
    ...
    @Test
    @DisplayName("Нельзя создать курьера только с одним логином")
    ...
    @Test
    @DisplayName("Нельзя создать курьера только с одним паролем")
    ...
    @Test
    @DisplayName("Нельзя создать курьера только с одним именем")
    ...
    @Test
    @DisplayName("Нельзя создать курьера без логина (только с паролем и именем)")
    ...
    @Test
    @DisplayName("Нельзя создать курьера без пароля (только с логином и именем)")
    ...
    @Test
    @DisplayName("Нельзя создать курьера без имени (только с логином и паролем)")
    ...
    @Test
    @DisplayName("Нельзя создать курьера с логином, который уже есть в системе")
