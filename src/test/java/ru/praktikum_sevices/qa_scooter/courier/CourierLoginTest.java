...
public class CourierLoginTest {
    ...
    @Test
    @DisplayName("Успешная авторизация курьера с валидными логином и паролем")
...
//    @Test
//    @DisplayName("Нельзя авторизоваться без логина и пароля")
...
//    }
    ...
    @Test
    @DisplayName("Нельзя авторизоваться c пустыми логином и паролем")
